...
WINDOW_WIDTH  = 900
WINDOW_HEIGHT = 600
FPS           = 60          # Target frame rate; higher = smoother but faster simulation
...
ANT_SPEED         = 3.0  # Forward displacement per DNA step in pixels
...
# Color Palette
# ---------------------------------------------------------------------------
COLOR_BG           = (18,  18,  28)    # Deep-space background
COLOR_WALL         = (70,  85,  95)    # Muted blue-grey walls
COLOR_WALL_EDGE    = (110, 125, 135)   # Subtle highlight on wall tops
COLOR_START_ZONE   = (40,  180, 80)    # Green start circle
COLOR_TARGET_ZONE  = (220, 170, 30)    # Amber target circle
COLOR_ANT_ALIVE    = (180, 210, 255)   # Cool blue for living ants
COLOR_ANT_DEAD     = (90,  60,  60)    # Dark red for crashed ants
COLOR_ANT_BEST     = (255, 230, 50)    # Gold for the evaluated best ant
COLOR_TRAIL_ALIVE  = (60,  80,  100)   # Dim trail for living ants
COLOR_TRAIL_BEST   = (180, 150, 20)    # Dim gold trail for the best ant
...
COLOR_ANT_UNIFORM   = (160, 190, 215)  # Soft blue: equal, unevaluated agents
COLOR_TRAIL_UNIFORM = (65,  85,  105)  # Dim trail matching the uniform body colour
COLOR_TEXT_PRIMARY = (230, 230, 240)   # Bright HUD text
COLOR_TEXT_DIM     = (140, 150, 160)   # Secondary HUD text
COLOR_HUD_BG       = (10,  12,  20)    # HUD panel background (drawn with alpha)
